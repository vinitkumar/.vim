...
set pastetoggle=<F2>
set ruler
set runtimepath=~/.vim,~/.vim/plugged/coc.nvim,~/.vim/plugged/ale,/usr/local/opt/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-highlightedyank,~/.vim/plugged/vim-commentary,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim81,/usr/local/share/vim/vimfiles/after,~/.vim/after
set secure
set shiftwidth=4
...
argglobal
%argdel
$argadd /private/tmp/zshMW4tIV
edit /private/tmp/zshMW4tIV
...
normal! 02|
tabnext 1
badd +1 /private/tmp/zshMW4tIV
badd +12 ~/commonchild.py
