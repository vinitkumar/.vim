...
set runtimepath+=~/.vim/plugged/vim-wakatime/
...
set runtimepath+=~/.vim/plugged/vim-prettier/
set runtimepath+=~/.vim/plugged/VimSplitBalancer/
...
set runtimepath+=~/.vim/plugged/vim-markdown-composer/
set runtimepath+=~/.vim/plugged/goyo.vim/
set runtimepath+=~/.vim/plugged/vim-reason-plus/
...
set runtimepath+=~/.vim/plugged/vim-markdown-composer/after
set runtimepath+=~/.vim/plugged/vim-reason-plus/after
...
silent only
silent tabonly
cd ~/projects/python/socialschools-cms-docker/static/js/event
